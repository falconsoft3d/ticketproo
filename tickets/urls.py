...
urlpatterns = [
    ...
    path('chatbots/<int:pk>/conversations/<int:conversation_id>/', views.chatbot_conversation_detail, name='chatbot_conversation_detail'),
    path('chatbots/<int:pk>/conversations/<int:conversation_id>/reply/', views.chatbot_conversation_reply, name='chatbot_conversation_reply'),
    path('chatbots/<int:pk>/conversations/<int:conversation_id>/delete/', views.chatbot_conversation_delete, name='chatbot_conversation_delete'),
    path('chatbots/<int:pk>/conversations/<int:conversation_id>/toggle-hide/', views.chatbot_conversation_toggle_hide, name='chatbot_conversation_toggle_hide'),
    path('chatbots/<int:pk>/conversations/<int:conversation_id>/toggle-reviewed/', views.chatbot_conversation_toggle_reviewed, name='chatbot_conversation_toggle_reviewed'),
    path('chatbots/<int:pk>/questions/create/', views.chatbot_question_create, name='chatbot_question_create'),
    path('chatbots/<int:pk>/questions/<int:question_id>/edit/', views.chatbot_question_edit, name='chatbot_question_edit'),
    path('chatbots/<int:pk>/questions/<int:question_id>/delete/', views.chatbot_question_delete, name='chatbot_question_delete'),
    path('chatbot/widget/<str:token>/', views.chatbot_widget, name='chatbot_widget'),
    ...
    path('contacts/autocomplete-ai/', views.contact_autocomplete_ai, name='contact_autocomplete_ai'),
    ...
    path('crm/process-surveys/<int:pk>/contract/save/', views.process_survey_contract_save, name='process_survey_contract_save'),
    path('crm/process-surveys/<int:pk>/duplicate/', views.process_survey_duplicate, name='process_survey_duplicate'),
    path('crm/process-surveys/<int:pk>/contract/parties/save/', views.process_survey_parties_save, name='process_survey_parties_save'),
    path('crm/process-surveys/clause/<int:clause_pk>/ai/', views.process_survey_clause_ai, name='process_survey_clause_ai'),
    path('crm/process-surveys/<int:pk>/clause/ai/new/', views.process_survey_clause_ai_new, name='process_survey_clause_ai_new'),
    path('crm/process-surveys/<int:pk>/clause/add/', views.process_survey_clause_add, name='process_survey_clause_add'),
    path('crm/process-surveys/clause/<int:clause_pk>/edit/', views.process_survey_clause_edit, name='process_survey_clause_edit'),
    path('crm/process-surveys/clause/<int:clause_pk>/delete/', views.process_survey_clause_delete, name='process_survey_clause_delete'),
    ...
    path('crm/process-surveys/line-categories/', views.process_survey_line_category_list, name='process_survey_line_category_list'),
    path('crm/process-surveys/line-categories/<int:pk>/delete/', views.process_survey_line_category_delete, name='process_survey_line_category_delete'),
    ...
    path('crm/process-surveys/public/<uuid:token>/contrato/', views.public_process_survey_contract, name='public_process_survey_contract'),
    ...
    path('crm/process-surveys/public/<uuid:token>/contrato/clausula/<int:clause_pk>/editar/', views.public_process_survey_clause_edit, name='public_process_survey_clause_edit'),
    path('crm/process-surveys/public/<uuid:token>/contrato/clausula/<int:clause_pk>/historial/', views.public_process_survey_clause_history, name='public_process_survey_clause_history'),
    ...
    path('crm/process-surveys/<int:pk>/contract/visitors/', views.process_survey_contract_visitors, name='process_survey_contract_visitors'),
    ...
    path('capacitaciones/<int:pk>/duplicar/', views.capacitacion_duplicate, name='capacitacion_duplicate'),
    ...
    path('capacitaciones/<int:pk>/clases/<int:clase_id>/eliminar/', views.capacitacion_clase_delete, name='capacitacion_clase_delete'),
    path('capacitaciones/<int:pk>/enlaces/<int:enlace_id>/eliminar/', views.capacitacion_enlace_delete, name='capacitacion_enlace_delete'),
    path('capacitaciones/<int:pk>/comentarios/<int:comentario_id>/eliminar/', views.capacitacion_comentario_delete, name='capacitacion_comentario_delete'),
    path('capacitaciones/<int:pk>/asistencias/<int:asistencia_id>/eliminar/', views.capacitacion_asistencia_delete, name='capacitacion_asistencia_delete'),
    path('capacitaciones/<int:pk>/solicitudes/<int:solicitud_id>/atender/', views.capacitacion_solicitud_toggle, name='capacitacion_solicitud_toggle'),
    path('capacitaciones/<int:pk>/solicitudes/<int:solicitud_id>/eliminar/', views.capacitacion_solicitud_delete, name='capacitacion_solicitud_delete'),
    ...
    path('public/capacitaciones/<uuid:token>/calendario/', views.capacitacion_public_calendario, name='capacitacion_public_calendario'),
    path('public/capacitaciones/clase/<uuid:token>/', views.capacitacion_clase_public, name='capacitacion_clase_public'),
