...
read -p 'Indique la dirección del repo a clonar (https://github.com/falconsoft3d/ticketproo): ' gitrepo
git -C /home/django clone $gitrepo
read -p 'Indique la el nombre de la carpeta del proyecto (ticketproo): ' project
read -p 'Indique el nombre de la app principal de Django (tickets): ' djapp
